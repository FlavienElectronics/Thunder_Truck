...
void ADC_Pot_IRQ_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)ADC_Pot_IRQ__INTC_NUMBER] = address;
}
...
cyisraddress ADC_Pot_IRQ_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)ADC_Pot_IRQ__INTC_NUMBER];
}
...
{
    *ADC_Pot_IRQ_INTC_PRIOR = priority << 5;
}
...
uint8 ADC_Pot_IRQ_GetPriority(void)
{
    ...
    priority = *ADC_Pot_IRQ_INTC_PRIOR >> 5;
